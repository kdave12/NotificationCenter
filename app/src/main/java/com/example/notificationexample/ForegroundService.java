...
public class ForegroundService extends Service {
        ...
        if(intent != null)
        {
            ...
            switch (action)
            {
                ...
                case ACTION_STOP_FOREGROUND_SERVICE:
                    ...
                    break;
                case ACTION_PLAY:
                    Toast.makeText(getApplicationContext(), "You click Play button.",
                            Toast.LENGTH_LONG).show();
                    break;
                case ACTION_PAUSE:
                    Toast.makeText(getApplicationContext(), "You click Pause button.",
                            Toast.LENGTH_LONG).show();
                    break;
            }
        }
    ...
    private void startForegroundService()
    {
        ...
        bigTextStyle.bigText("Android foreground service is a android service which can run in " +
                "foreground always, it can be controlled by user via notification.");
        // Set big text style.
